...
class BedroomLightHandler:
    def can_handle(self, event: dict) -> bool:
        return event.get("type") == "device_param_update" and \
            ...
            (event.get("device_id") == "hue_sensor_12" and \
    ...
    def handle(self, event: dict, context: Context) -> List[dict]:
        ...
        if event.get("device_id") == "c2b38173-883e-4766-bcb5-0cce2dc0e00e":
            ...
            if not event.get("value"):
                actions.append({
                    "type": "device_param_update",
                    "device_id": "hue_sensor_12",
                    "param": "on",
                    "value": False
                })

        elif event.get("device_id") == "scene_dim":
            if event.get("value") and context.get("hue_6", "on"):
                actions.append({
                    "type": "device_param_update",
                    "device_id": "rgb003",
                    "param": "on",
            ...
            elif not event.get("value") and context.get("rgb003", "on"):
                actions.append({
                    "type": "device_param_update",
                    "device_id": "rgb003",
                    "param": "on",
