...
export default function Home(props) {
  ...
  const [fire_nearest, setFireNearest] = useState(null)
  ...
  useEffect(() => {
    ...
    sse.onmessage = e => {
      ...
      if (event.type === "internet-status") {setInternetStatus(event.data)}
      ...
      else if (event.type === "fire-nearest") {setFireNearest(event.data);}
    };
    sse.onerror = () => {
      setSeeClosed(true)
      // sse.close();
