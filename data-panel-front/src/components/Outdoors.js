        ...
        <div className="outdoorCardRow">
            ...
            <div className="outdoorCardColumn outdoorCardWeatherContainer">
                <div className="outdoorCardWeatherRow">
                    <div className="outdorrCardWeatherTemperatureContainer">
                            {props.weather.temp_c} ºC
                        </div>
                    </div>
                <div className="outdoorCardWeatherRow">
                    <div className="outdorrCardWeatherSkyContainer">
                        <img className="outdorrCardWeatherSkyIcon" alt="f" src={props.weather.condition.icon}/>
                    </div>
                    <div className="outdorrCardWeatherUVindexContainer">
                        {props.weather.uv}
                    </div>
                    <div className="outdorrCardWeatherAQIContainer">
